...
def register(bot):
    ...
    @bot.message_handler(func=lambda m: m.text and m.text.endswith("My events"))
    def my_events(msg):
        uid = msg.from_user.id
    ...
    @bot.message_handler(func=lambda m: m.text and m.text.endswith("Friends events"))
    ...
    @bot.message_handler(func=lambda m: m.text and m.text.endswith("Public events"))
